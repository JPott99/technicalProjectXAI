...
for k in range(loops):
    ...
    for j in range(subloops):
        agentArrayZ = zealousXAI.genAgents(50,0.9)
        agentArrayF = fickleXAI.genAgents(50,0.9)
        agentArrayT = testerXAI.genAgents(50,0.9)
        agentArraySF = superFickleXAI.genAgents(50,0.9)
        counter  = 0
...
plt.legend(["Zealous","Fickle","Tester", "Super Fickle"])
plt.xlabel("Environmental Reliability")
plt.ylabel("Number of Iterations to Convergence")
plt.title("Graph comparing performance of different agent behaviours against Environmental Reliability")
plt.savefig("Graphs/RelTests/envRelTestAR90.png")
plt.show()
